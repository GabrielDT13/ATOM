...
- `sql/10_internal/35_dashboard_activity.sql`: valida columnas, indices, policies y grants del bloque de actividad del dashboard.
...
psql postgresql://postgres:postgres@127.0.0.1:54322/postgres -f supabase/tests/sql/10_internal/35_dashboard_activity.sql
